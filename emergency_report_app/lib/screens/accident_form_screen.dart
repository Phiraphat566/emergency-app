...
class AccidentFormScreen extends StatefulWidget {
  @override
  _AccidentFormScreenState createState() => _AccidentFormScreenState();
}
...
class _AccidentFormScreenState extends State<AccidentFormScreen> {
  ...
  Future<void> submitData() async {
    try {
      ...
      await _firebaseService.submitAccidentReport(
        nameController.text,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInputField(detailsController, 'รายละเอียดเหตุการณ์', hintText: 'กรุณาระบุรายละเอียดเหตุการณ์'),
